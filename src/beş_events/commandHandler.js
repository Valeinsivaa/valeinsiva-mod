...
module.exports = async (message) => {
    ...
    if(chatChannel && message.channel.id == chatChannel && !["snipe","tag","afk","sil"].some(bes => cmd.name == bes)) return client.false(message);
    ...
    .setFooter({ text: beş_config.footer ? beş_config.footer : `Valeinsiva Was Here `, iconURL: message.author.avatarURL({ dynamic: true, size: 2048 }) })
