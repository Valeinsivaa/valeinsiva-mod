...
module.exports = {
    ...
    execute: async (client, message, args, beş_embed) => {
      if(!["bot","commands","command","komut"].some(bes => message.channel.name.includes(bes))) return message.channel.send({ embeds: [beş_embed.setDescription(`> **Afk Komutunu Sadece Adında "bot","commands","command","komut" İçeren Kanallarda Kullanabilirsin!**`)] }).sil(5);
